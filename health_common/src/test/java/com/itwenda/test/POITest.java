...
public class POITest {
    ...
    public void test1() throws Exception{
        ...
        XSSFWorkbook excel = new XSSFWorkbook(new FileInputStream(new File("e:\\hello.xlsx")));
    ...
    public void test3() throws Exception{
        ...
        //创建一个工作表对象
        XSSFSheet sheet = excel.createSheet("文达健康");
        //在工作表中创建行对象
    ...
    public void test6(){
        try {
            SMSUtils.sendShortMessage("SMS_183795616","19966530843","1234");
        } catch (ClientException e) {
            System.out.println("阿里云短信发送异常。未成功。");
            e.printStackTrace();
        }
    }
}
