...
public class SMSUtils {
	...
	public static void sendShortMessage(String templateCode,String phoneNumbers,String param) throws ClientException{
		...
		// 替换成你的AK
		final String accessKeyId = "LTAI4FrVWGk8YC5CueALXyqD";// 你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "fTWf2HAvlOstg8JtIgKB541yhWDE8l";// 你的accessKeySecret，参考本文档步骤2
